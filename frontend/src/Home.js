...
//             {/* ✅ Only show See More if there are more than 8 */}
//             {filtered.length > limitedCount && (
//               <div className="see-more-wrap">
//                 <button className="btn-primary" onClick={handleSeeMore}>
//                   See More
...
//           </div>
//           <div className="landing-right">
//             {/* ✅ WRAP IMAGE WITH RAINBOW BORDER DIV */}
...
function Home({ products = [], addToCart, addToWishlist }) {
  ...
  // ✅ For image slideshow
 const images = [
  "https://img.freepik.com/free-photo/portrait-happy-young-woman-shopping_329181-8826.jpg?semt=ais_hybrid",
  "https://img.freepik.com/free-photo/attractive-woman-holding-shopping-bags_329181-9202.jpg?semt=ais_hybrid",
  "https://img.freepik.com/free-photo/two-happy-women-shopping-together_329181-8673.jpg?semt=ais_hybrid",
  "https://img.freepik.com/free-photo/smiling-girl-shopping-bags_329181-8467.jpg?semt=ais_hybrid",
];
            ...
            <div className="product-grid">
              {visibleItems.map((p) => {
                ...
                return (
                  <div key={p._id || p.id} className="product-card v2">
                    <div className="product-img-block">
                      <img src={p.image} alt={p.name || brand} loading="lazy" />
                    </div>
